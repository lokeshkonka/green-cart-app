  ...
  return (
    <div className='relative'>
      ...
      <div className='absolute inset-0 flex flex-col items-center md:items-start justify-end md:justify-center pb-24 md:pb-0 px-4 md:pl-16 lg:pl-24'>
        <h1 className='text-3xl md:text-4xl lg:text-5xl font-bold text-center md:text-left max-w-[18rem] md:max-w-[22rem] lg:max-w-[26rem] leading-tight lg:leading-snug'>
          Freshness to trust, and savings You Will Goon
        </h1>
